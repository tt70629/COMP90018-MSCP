...
public class DAObuylist {
    ...
    public DAObuylist()
    {
        ...
        databaseReference = db.getReference(Buylist.class.getSimpleName());
    }
    public Task<Void> add(Buylist buylist)
    {
        return databaseReference.push().setValue(buylist);
    }
